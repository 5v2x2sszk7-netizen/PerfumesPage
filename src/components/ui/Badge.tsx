...
function sizeClass(size: BadgeSize) {
  if (size === "xs") return "px-3.5 py-1 text-[11px] font-medium tracking-[0.18em]"
  if (size === "md") return "px-5 py-2.5 text-sm font-medium tracking-wide"
  return "px-4 py-1.5 text-ui-2xs font-medium tracking-kicker"
}
...
export function Badge({
  ...
  return (
    <span
      className={cn(
        "inline-flex max-w-full items-center justify-center rounded-full ring-1 ring-inset whitespace-nowrap",
